...
for i in `cat inference_input_level2.txt`
do
	echo $i
	...
	python /dtascfs/DL/lungcancer/AD_SC_PDL1/scripts/Lung_DL/predicted_val_name.py -t $DATASET_DIR/$i -i k.txt >> level2_res.txt
