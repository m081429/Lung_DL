...
TF_DIR=/dtascfs/DL/lungcancer/AD_SC_PDL1/TFRECORDS
Patch_size=224
...
do
	...
	if [ -f $svs_file  ]; then
		...
		python /dtascfs/DL/lungcancer/AD_SC_PDL1/scripts/Lung_DL/Create_TCGA_ImagePatches_level2.py -i $temp_dir/$samp.txt -p $PATCH_DIR -o $TF_DIR -s $Patch_size
